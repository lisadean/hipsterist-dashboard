...
class TimerButton extends Component {
    ...
    getButton() {
        if (this.props.timerState === timerStates.NOT_SET)
            ...
            return (<button className="btn btn-danger" onClick={this.props.startTimer}>Start</button>);

            if (this.props.timerState === timerStates.COMPLETE)
            return (<button className="btn btn-info" onClick={this.props.startTimer}>Start</button>);
    }
